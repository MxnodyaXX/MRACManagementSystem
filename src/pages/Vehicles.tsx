...
import { Plus, Car, Pencil, Trash2, Shield } from 'lucide-react';
...
const empty = (): Omit<Vehicle, 'id' | 'createdAt' | 'revenue'> => ({
  vehicleNumber: '',
  brand: '',
  model: '',
...
export default function Vehicles() {
  const { vehicles, owners, addVehicle, updateVehicle, deleteVehicle } = useStore();
  ...
  const handleSave = () => {
    if (modal === 'add') {
      ...
      updateVehicle(selected.id, form);
    }
    setModal(null);
  };
  ...
  return (
    <div>
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-xs font-medium transition-colors flex-shrink-0 ${
                filter === s
                  ...
                  : 'bg-white text-navy-500 hover:bg-navy-50 shadow-card'
              }`}
            >
              {s}
              {s !== 'All' && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-navy-800">{v.brand} {v.model}</p>
              ...
              <div className="flex items-center justify-between border-t border-navy-50 pt-3">
                <div>
                  <p className="text-xs text-navy-400">Revenue Generated</p>
        ...
        {filtered.length === 0 && (
          <div className="col-span-3 text-center py-16 text-navy-400 text-sm">
            No vehicles found.
          </div>
        )}
      </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-xl bg-navy-50 flex items-center justify-center">
                  <Car size={24} className="text-navy-600" />
                </div>
                <div>
                ...
                <div className="ml-auto"><StatusBadge status={selected.status} size="md" /></div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <div key={label} className="bg-navy-50/60 rounded-xl p-3">

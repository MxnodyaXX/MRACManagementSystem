...
/** Phone that receives internal admin/staff alerts (set VITE_ADMIN_PHONE in .env). */
export const ADMIN_PHONE = (import.meta.env.VITE_ADMIN_PHONE as string | undefined) ?? '';
